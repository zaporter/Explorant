...
* hecked_request2size (size_t req) __nonnull (1)
{
...
static inline void
* advise_thp (void *p, INTERNAL_SIZE_T size)
{
...
static void *
* ysmalloc_mmap (INTERNAL_SIZE_T nb, size_t pagesize, int extra_flags, mstate av)
{
*  long int size;
